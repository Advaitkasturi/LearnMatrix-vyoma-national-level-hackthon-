...
const EventInfo = [
    ...
    
    {
      ...
      img:<iframe width="560" height="315" src="https://www.youtube.com/embed/E06r3zpoT24?si=hRyTzn5YFEDAroty" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>,
      content:
        "Vitual Vista panel 1"       
       ,
      ...
      id: "#",
      title: "Virtual Vista 2.0",
      img:<iframe width="560" height="315" src="https://www.youtube.com/embed/NIwrQQSxcWQ?si=MHYYyfBjqryUUpIO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>,
      content:
        "Vitual Vista panel 2"       
       ,
      ...
      id: "#",
      title: "Virtual Vista 2.0",
      img:<iframe width="560" height="315" src="https://www.youtube.com/embed/wkJc2UeUMG8?si=wc-bdnzPR2YsYz6z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>,
      content:
        "Vitual Vista panel 3"       
       ,
      ...
      id: "#",
      title: "Virtual Vista 2.0",
      img:<iframe width="560" height="315" src="https://www.youtube.com/embed/8rpIsL2aOco?si=WodT-96lMOHwZ_Gp" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>,
      content:
        "Vitual Vista panel 4"       
       ,
      ...
      id: "#",
      title: "Virtual Vista 2.0",
      img:<iframe width="560" height="315" src="https://www.youtube.com/embed/Wvrv6DxCtog?si=DL7hkXDnsAfDAdqu" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>,
      content:
        "Vitual Vista panel 5"       
       ,
      ...
      id: "#",
      title: "HACK ARENA",
      img:<iframe width="560" height="315" src="https://www.youtube.com/embed/eS7y7l_4ejU?si=6hD2l4pjYKKZ-U64" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>,
      content:
        "Elevating ideas empowering futures..."       
       ,
